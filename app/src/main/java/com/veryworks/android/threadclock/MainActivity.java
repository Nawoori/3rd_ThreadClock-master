...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SecondHand hand1 = new SecondHand(5, center_x, center_y, LINE, 0);
        stage.addHand(hand1);

        SecondHand hand2 = new SecondHand(5, center_x, center_y, LINE, 1000);
        stage.addHand(hand2);

        SecondHand hand3 = new SecondHand(5, center_x, center_y, LINE, 360*60);
        stage.addHand(hand3);
